...
| omp         | 2     | 0.06192   | 2.31    | 115.5%      |
| omp         | 4     | 0.07065   | 2.02    | 50.5%       |
| omp         | 8     | 0.06566   | 2.18    | 27.3%       |
...
| omp         | 2     | 0.06131   | 2.33    | 116.5%      |
| omp         | 4     | 0.06818   | 2.09    | 52.3%       |
| omp         | 8     | 0.06400   | 2.23    | 27.9%       |


## 8. Conclusions
MPI реализация алгоритма увеличения контраста демонстрирует положительное ускорение на всех тестируемых конфигурациях. Максимальное ускорение 2.33 достигнуто в режиме task_run при использовании 2 процессов. На 4 процессах ускорение несколько снижается (до 2.09), что связано с возросшими накладными расходами на коммуникацию.
