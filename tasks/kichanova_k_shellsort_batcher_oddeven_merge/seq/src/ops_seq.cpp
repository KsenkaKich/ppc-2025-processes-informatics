...
KichanovaKShellsortBatcherOddEvenMergeSEQ::KichanovaKShellsortBatcherOddEvenMergeSEQ(const InType &in) {
  SetTypeOfTask(GetStaticTypeOfTask());
  GetInput() = in;
  GetOutput() = 0;
}

bool KichanovaKShellsortBatcherOddEvenMergeSEQ::ValidationImpl() {
  return GetInput() > 0;
}

bool KichanovaKShellsortBatcherOddEvenMergeSEQ::PreProcessingImpl() {
  return true;
}
...
bool KichanovaKShellsortBatcherOddEvenMergeSEQ::PostProcessingImpl() {
  return GetOutput() > 0;
}
