...
TEST_P(KichanovaKShellsortBatcherOddEvenMergePerfTests, RunPerfModes) {
...
const auto kPerfTestName = KichanovaKShellsortBatcherOddEvenMergePerfTests::CustomPerfTestName;

INSTANTIATE_TEST_SUITE_P(RunModeTests, KichanovaKShellsortBatcherOddEvenMergePerfTests, kGtestValues, kPerfTestName);
