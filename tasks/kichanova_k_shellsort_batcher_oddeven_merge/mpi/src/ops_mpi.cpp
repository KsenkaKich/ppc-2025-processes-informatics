...
KichanovaKShellsortBatcherOddEvenMergeMPI::KichanovaKShellsortBatcherOddEvenMergeMPI(const InType &in) {
  SetTypeOfTask(GetStaticTypeOfTask());
  GetInput() = in;
  GetOutput() = 0;
}

bool KichanovaKShellsortBatcherOddEvenMergeMPI::ValidationImpl() {
  return (GetInput() > 0) && (GetOutput() == 0);
}

bool KichanovaKShellsortBatcherOddEvenMergeMPI::PreProcessingImpl() {
  int initialized = 0;
...
void KichanovaKShellsortBatcherOddEvenMergeMPI::ShellSort(std::vector<int> &arr) {
...
bool KichanovaKShellsortBatcherOddEvenMergeMPI::PostProcessingImpl() {
  return GetOutput() > 0;
}
